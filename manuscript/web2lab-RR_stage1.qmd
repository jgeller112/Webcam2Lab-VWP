...
keywords: [wWbcam eye-tracking, Webcams, Visual world paradigm,  Lab-based experimentation, Competition, Spoken word recognition]
authornote: |
...
More targeted evidence suggests that hardware quality may nonetheless play a role in shaping webcam-based eye-tracking performance. Slim and Hartsuiker (2023) reported a positive association between sampling rate of the webcamera and calibration accuracy, and @gellerLanguageBordersStepbystep2025f found that participants who failed calibration more frequently were more likely to report using standard-quality built-in webcams and completing the study in sub-optimal environments (e.g., natural lighting).
...
![Trial Schematic for webcam VWP.](vwp_trial.png){fig-align="center"}
