...
More targeted evidence suggests that hardware quality may nonetheless play a role in shaping webcam-based eye-tracking performance. Slim and Hartsuiker (2023) reported a positive association between sampling rate of webcams and calibration accuracy, and @gellerLanguageBordersStepbystep2025f found that participants who failed calibration more frequently were more likely to report using standard-quality built-in webcams and completing the study in sub-optimal environments (e.g., natural lighting).
